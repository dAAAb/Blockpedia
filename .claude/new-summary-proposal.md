...
1. **保留循序漸進的知識架構** — 沿用原始「幣→帳本→區塊鏈」的學習路徑
2. **主題分群更清晰** — 相關內容集中，減少跳躍
3. **擴充現代 Web3 內容** — 補充 2020 年後的重大發展
4. **安全導向** — 將安全相關內容提升優先順序
5. **標註內容狀態** — 區分「已完成」「待撰寫」「歷史條目」
...
### 1. 結構重組
- 從 394 行扁平清單 → **26 個主題篇章**
- 每篇有明確主題，方便讀者按需閱讀

### 2. 新增篇章（2020-2026 新趨勢）

| 篇章 | 主題 | 重點內容 |
|------|------|----------|
| 第十篇 | DeFi 去中心化金融 | AMM、借貸、流動性挖礦 |
| 第十一篇 | Layer 2 擴容方案 | Rollups、Polygon、Arbitrum |
| 第十三篇 | DAO 與 Web3 治理 | 治理代幣、投票機制 |
| 第二十篇 | **AI x Web3** 🆕 | x402 Protocol、AI Agent 支付 |
| 第二十一篇 | **預測市場** 🆕 | Polymarket、群眾智慧 |
| 第二十二篇 | **CBDC 央行數位貨幣** 🆕 | 數位人民幣、e-rupee、MiCA |
| 第二十三篇 | **RWA 真實世界資產** 🆕 | 代幣化國債、BlackRock BUIDL |
| 第二十四篇 | **DePIN** 🆕 | Helium、Render、Hivemapper |
| 第二十五篇 | **全球監管框架** 🆕 | MiCA、GENIUS Act、香港/新加坡 |
| 第二十六篇 | **Web3 支付** 🆕 | Stripe+Bridge、Block BTC |

### 3. 擴充現有章節

**比特幣生態（第二篇）**
- Bitcoin ETF（2024 年批准）
- Bitcoin Ordinals / BRC-20 / Runes
- Lightning Network

**穩定幣（第八篇）**
- USDe（Ethena）、PYUSD（PayPal）、USD1
- JPYC（日圓）、EURC（歐元）
- 收益型穩定幣
...
| 原位置 | 新位置 | 原因 |
|--------|--------|------|
| 散落的 NFT 內容 | 第十二篇集中 | 主題集中 |
| 穩定幣在交易所下 | 第八篇交易所內 | 邏輯相關 |
| 組織/名人/新聞 | 第十七篇鏈圈幣圈 | 社群生態集中 |
